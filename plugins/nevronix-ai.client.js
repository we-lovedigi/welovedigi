	...
	if (!document.getElementById(id)) {
		...
		s.onload = () => {
			...
			if (api && typeof api.init === "function") {
				api.init({
					apiUrl: "https://platform.nevronix.ai?id=47&s=01cb7098-142b-4133-a174-80e224b10ede&doNotInteruptAvatar=false&showMessagesOnMobile=true&alwaysDisableMic=true&maxHeightMessages=25px",
